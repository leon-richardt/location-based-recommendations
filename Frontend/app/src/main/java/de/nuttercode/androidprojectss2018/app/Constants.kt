...
const val PERIODIC_EVENT_UPDATES_JOB_ID = 30
const val PERIODIC_TAG_UPDATES_JOB_ID = 31

const val PERIODIC_EVENT_UPDATES_JOB_INTERVAL = 1000L * 60 * 15 // 15 minutes
const val PERIODIC_TAG_UPDATES_JOB_INTERVAL = 1000L * 60 * 60 // 1 hour

const val NOTIFICATION_CHANNEL_ID = "DEBUG"
