	...
	\begin{frame}{Server - Schematischer Ablauf}
		...
		\resizebox{!}{\textheight-1.5cm}{%
			\begin{tikzpicture}[node distance = 1cm, auto]
				...
				\node [block, node distance=4cm, left of=class, yshift=-1cm] (readevents) {nahe Events lesen};
				\node [block, right of=filterevents, xshift=2cm, right of=class, yshift=-1.75cm] (readtags) {alle Tags lesen};
				\node [block, below of=readevents] (filterevents) {nach Tags filtern};
